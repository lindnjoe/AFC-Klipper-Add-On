"""
Tests for the Pico bridge, extras/AFC_BambuAMS_bridge.py.

Event dispatch, the import guards, the console narration, and the per-model
narration dialects asserted against real captures in
tests/fixtures/ams_narration/ -- see that directory's README for the format.
...
# ── BambuAMS_bridge ───────────────────────────────────────────────────────────
#
# was tests/test_AFC_BambuAMS_bridge.py
...
# ── narration_dialects ────────────────────────────────────────────────────────
#
# was tests/test_AFC_bambu_narration_dialects.py
